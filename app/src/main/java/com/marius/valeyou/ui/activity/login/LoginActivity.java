            ...
            public void onRequestReceived(@NonNull Resource<SimpleApiResponse> resource) {
                switch (resource.status) {
                    ...
                    case SUCCESS:
                        ...
                        Intent intent = LoginChooseActivity.newIntent(LoginActivity.this, "login");
...
//                        vm.success.setValue(resource.message);
                        if (resource.data.getIsEmailVerify() == 0) {
                            ...
                            Intent intent1 = LoginChooseActivity.newIntent(LoginActivity.this, "login");
                ...
                switch (resource.status) {
                    ...
                    case SUCCESS:
                        ...
                        if (resource.data != null && resource.data.getStatus() == 1) {
                            intent1 = LoginChooseActivity.newIntent(LoginActivity.this, "login");
